...
/*
 * GUC variable to enable/disable remote plan display in EXPLAIN output.
 * Default is off for backward compatibility.
 */
bool		show_remote_plans = false;
...
_PG_init(void)
{
	...
	DefineCustomBoolVariable("postgres_fdw.show_remote_plans",
							 "Show remote execution plans in EXPLAIN output.",
							 "When enabled, EXPLAIN VERBOSE will fetch and display "
							 "execution plans from foreign servers.",
							 &show_remote_plans,
							 false,
							 PGC_USERSET,
							 0,
